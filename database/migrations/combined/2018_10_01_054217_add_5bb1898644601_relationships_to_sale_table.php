...
class Add5bb1898644601RelationshipsToSaleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('sales', function(Blueprint $table) {
            if(Schema::hasColumn('sales', 'assigned_to_id')) {
                $table->dropForeign('213911_5bb1744081a67');
                $table->dropIndex('213911_5bb1744081a67');
                $table->dropColumn('assigned_to_id');
            }
            if(Schema::hasColumn('sales', 'created_by_id')) {
                $table->dropForeign('213911_5bb17440947d0');
                $table->dropIndex('213911_5bb17440947d0');
                $table->dropColumn('created_by_id');
            }
            if(Schema::hasColumn('sales', 'created_by_team_id')) {
                $table->dropForeign('213911_5bb17440aaa34');
                $table->dropIndex('213911_5bb17440aaa34');
